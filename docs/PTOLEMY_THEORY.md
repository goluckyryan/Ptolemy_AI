...
**Step 3:** The angular integrals over the direction vectors produce Clebsch-Gordan coefficients and 3j-symbols, coupling $(L_i, l_T, l_P, L_o)$ to a transferred angular momentum $L_x$. Selection rules enforce $|L_i - L_o| \leq L_x \leq L_i + L_o$ and $|l_T - l_P| \leq L_x \leq l_T + l_P$.
